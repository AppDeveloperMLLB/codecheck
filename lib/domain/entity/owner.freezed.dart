...
abstract class $OwnerCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String avatarUrl});
}
...
class _$OwnerImpl extends _Owner with DiagnosticableTreeMixin {
  const _$OwnerImpl({required this.id, required this.avatarUrl}) : super._();
...
abstract class _Owner extends Owner {
  const factory _Owner(
      {required final int id, required final String avatarUrl}) = _$OwnerImpl;
